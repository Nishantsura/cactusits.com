          ...
          {industries.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              {industries.map((industry) => (
                <div key={industry.id} className="border border-gray-200 rounded-lg overflow-hidden bg-white hover:shadow-md transition-shadow">
                  {/* Industry card header */}
                  <div className="p-4 border-b border-gray-100 flex justify-between items-center">
                    <h3 className="font-medium text-lg">{industry.name || industry.hero_industry}</h3>
                  ...
                  <div className="p-4">
                    <div className="mb-3">
                      ...
                      <span className="text-gray-700 ml-2 text-sm font-mono">{industry.slug}</span>
                    </div>
                    <div className="mb-3">
                      <span className="text-gray-500 text-sm">Description:</span>
                      <p className="text-gray-700 text-sm mt-1">
                        {formatExcerpt(industry.description || industry.hero_description, 120)}
                      </p>
                    </div>
                  ...
                  {deleteConfirm === industry.id && (
                    <div className="p-4 bg-red-50 border-t border-red-100">
                      <p className="text-red-700 text-sm mb-3">
                        Are you sure you want to delete this industry? This cannot be undone.
                      </p>
