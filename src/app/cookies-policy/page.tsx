      ...
      <div className="prose prose-sm md:prose-base lg:prose-lg max-w-none">
        <section className="mb-8">
          <p className="mb-4">
            ...
            and how and they&apos;re being used by the cactusits.com website
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            cookies&quot;). These third parties can recognise you when you visit
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              ...
              <p>
                ...
                using its features. For example, these cookies let us recognise
            ...
            <li>
              ...
              <p>
                ...
                recognise your username and remember how you customised the
            ...
            <li>
              ...
              <p>
                ...
                or use the Website and Services, or share content, by using a
              ...
              <p>
                ...
                accordance with our and social networks&apos; privacy policies.
                We will not collect or share any personally identifiable
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            to abide by the terms of this Policy, you are not authorised to
            access or use the Website and Services. This cookie policy was
