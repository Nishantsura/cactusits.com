    ...
    try {
      ...
      try {
        ...
        if (error) {
          ...
          console.log(`✅ Service "${service.Hero.service}" seeded with fallback method`);
        }
      } catch (fallbackErr) {
    ...
    try {
      ...
      if (error) {
        ...
        if (fallbackError) {
          ...
          console.log(`✅ Industry "${industry.Hero.industry}" seeded with fallback method`);
        }
      } else {
        console.log(`✅ Industry "${industry.Hero.industry}" seeded successfully`);
      }
    } catch (err) {
...
async function createSqlFunction() {
  ...
  try {
    ...
    if (error) {
      console.warn('Could not create SQL function, will try alternative seeding method:', error);
      return false;
    }
    ...
    console.warn('Error creating SQL function, will try alternative seeding method:', err);
    return false;
  }
}
